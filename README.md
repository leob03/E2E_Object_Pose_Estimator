...
In this project, we implemented an **end-to-end** object pose estimator, based on [PoseCNN]([https://arxiv.org/abs/1711.00199](https://leobringer.files.wordpress.com/2023/09/written-report.pdf)), which consists of two stages - feature extraction with a backbone network and pose estimation represented by instance segmentation, 3D translation estimation, and 3D rotation estimation.
